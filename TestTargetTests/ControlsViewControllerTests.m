...
//                                     @"toolbar button",
    ...
    for ( NSString *accessibilityLabel in accessibilityLabels ) {
        ...
        [FRY_KEY fry_enumerateDepthFirstViewMatching:@{kFRYLookupAccessibilityLabel : @"No Action"}
                                          usingBlock:^(UIView *view, CGRect frameInView) {
                                              XCTAssertNotNil(view);
                                          }];
    }
...
- (void)testSlider
{
    [FRY_KEY fry_simulateTouch:[FRYSyntheticTouch touchStarting:0.000
             ...
             onSubviewMatching:@{@"accessibilityLabel" : @"Slider"}];
    [[NSRunLoop currentRunLoop] fry_waitForIdle];
    [FRY_KEY fry_enumerateDepthFirstViewMatching:@{kFRYLookupAccessibilityLabel : @"Slider=1"}
                                      usingBlock:^(UIView *view, CGRect frameInView) {
                                          XCTAssertNotNil(view);
                                      }];
    ...
    [FRY_KEY fry_simulateTouch:[FRYSyntheticTouch touchStarting:0.000
             ...
             onSubviewMatching:@{@"accessibilityLabel" : @"Slider"}];
    [[NSRunLoop currentRunLoop] fry_waitForIdle];
    [FRY_KEY fry_enumerateDepthFirstViewMatching:@{kFRYLookupAccessibilityLabel : @"Slider=100"}
                                      usingBlock:^(UIView *view, CGRect frameInView) {
                                          XCTAssertNotNil(view);
                                      }];
    ...
    [FRY_KEY fry_simulateTouch:[FRYSyntheticTouch touchStarting:0.000
             ...
             onSubviewMatching:@{@"accessibilityLabel" : @"Slider"}];
    [[NSRunLoop currentRunLoop] fry_waitForIdle];
    [FRY_KEY fry_enumerateDepthFirstViewMatching:@{kFRYLookupAccessibilityLabel : @"Slider=49"}
                                      usingBlock:^(UIView *view, CGRect frameInView) {
                                          XCTAssertNotNil(view);
                                      }];
}
...
- (void)testActivityIndicator
{
    ...
    [FRY_KEY fry_simulateTouch:[FRYSyntheticTouch tap]
             onSubviewMatching:@{kFRYLookupAccessibilityLabel : @"Switch"}];
    [[NSRunLoop currentRunLoop] fry_waitForIdle];
