...
- (void)testSlider
{
    ...
    [[NSRunLoop currentRunLoop] fry_waitForIdle];
    [FRY_KEY fry_farthestDescendentMatching:[NSPredicate fry_matchAccessibilityLabel:@"Slider=1"]
                                 usingBlock:^(UIView *view, CGRect frameInView) {
                                     XCTAssertNotNil(view);
                                 }];
    ...
    [FRY_KEY fry_simulateTouch:[FRYSyntheticTouch touchStarting:0.000
             ...
             onSubviewMatching:[NSPredicate fry_matchAccessibilityLabel:@"Slider"]];
    [[NSRunLoop currentRunLoop] fry_waitForIdle];
    [FRY_KEY fry_farthestDescendentMatching:[NSPredicate fry_matchAccessibilityLabel:@"Slider=98"]
                                 usingBlock:^(UIView *view, CGRect frameInView) {
                                     XCTAssertNotNil(view);
                                 }];
    ...
    [FRY_KEY fry_simulateTouch:[FRYSyntheticTouch touchStarting:0.000
             ...
             onSubviewMatching:[NSPredicate fry_matchAccessibilityLabel:@"Slider"]];
    [[NSRunLoop currentRunLoop] fry_waitForIdle];
    [FRY_KEY fry_farthestDescendentMatching:[NSPredicate fry_matchAccessibilityLabel:@"Slider=49"]
                                 usingBlock:^(UIView *view, CGRect frameInView) {
                                          XCTAssertNotNil(view);
                                      }];
}
...
- (void)testStepper
{
    ...
    [FRY_KEY fry_farthestDescendentMatching:[NSPredicate fry_matchAccessibilityLabel:@"Slider=55"]
                                 usingBlock:^(UIView *view, CGRect frameInView) {
                                     XCTAssertNotNil(view);
                                 }];
    for ( NSUInteger i = 0; i < 5; i++) {
