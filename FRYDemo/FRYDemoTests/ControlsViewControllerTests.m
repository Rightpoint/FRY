...
- (void)testAccessibilityLabelLookup
{
    ...
    for ( NSString *accessibilityLabel in accessibilityLabels ) {
        FRY2.lookupFirstByAccessibilityLabel(accessibilityLabel).present();
    }
}
...
- (void)testTapping
{
    ...
    for ( id accessibilityInfo in accessibilityLabels ) {
        ...
        FRY2.lookupFirstByAccessibilityLabel(accessibilityLabel).tap();
        FRY2.lookupFirstByAccessibilityLabel(actionConfirmation).count(1);
    }
}
...
- (void)testTappingDisabled
{
    ...
    for ( NSString *accessibilityLabel in accessibilityLabels ) {
        ...
        FRY2.lookupFirstByAccessibilityLabel(actionConfirmation).absent();
        FRY2.lookupFirstByAccessibilityLabel(@"No Action").present();
    }
}

- (void)testSlider
{
    FRY2.lookupFirstByAccessibilityLabel(@"Slider").touch([FRYTouch touchStarting:0.000
                                                                           points:40
    ...
    FRY2.lookupFirst([NSPredicate predicateWithFormat:@"fry_accessibilityLabel = 'Slider=0' || fry_accessibilityLabel = 'Slider=5'"]).count(1);
    ...
    FRY2.lookupFirst([NSPredicate predicateWithFormat:@"fry_accessibilityLabel = 'Slider=100' || fry_accessibilityLabel = 'Slider=95'"]).count(1);
    ...
    FRY2.lookupFirstByAccessibilityLabel(@"Slider=50").count(1);
}

- (void)testStepper
{
    for ( NSUInteger i = 0; i < 5; i++) {
        FRY2.lookupFirstByAccessibilityLabel(@"Increment").tap();
    }
    FRY2.lookupFirstByAccessibilityLabel(@"Slider=75").count(1);

    for ( NSUInteger i = 0; i < 5; i++) {
        FRY2.lookupFirstByAccessibilityLabel(@"Decrement").tap();
    }
    FRY2.lookupFirstByAccessibilityLabel(@"Slider=50").count(1);
}
...
- (void)testActivityIndicator
{
    ...
    FRY2.lookupFirstByAccessibilityLabel(@"Switch").tap();
    FRY2.lookupFirstByAccessibilityLabel(@"In progress").count(0);
