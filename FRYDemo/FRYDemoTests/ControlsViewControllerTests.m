...
- (void)testAccessibilityLabelLookup
{
    ...
    for ( NSString *accessibilityLabel in accessibilityLabels ) {
        FRY.lookupByAccessibilityLabel(accessibilityLabel).present();
    }
}
...
- (void)testTapping
{
    ...
    for ( id accessibilityInfo in accessibilityLabels ) {
        ...
        FRY.lookupByAccessibilityLabel(accessibilityLabel).tap();
        FRY.lookupByAccessibilityLabel(actionConfirmation).count(1);
    }
}
...
- (void)testTappingDisabled
{
    ...
    for ( NSString *accessibilityLabel in accessibilityLabels ) {
        ...
        FRY.lookupByAccessibilityLabel(actionConfirmation).absent();
        FRY.lookupByAccessibilityLabel(@"No Action").present();
    }
}

- (void)testSlider
{
    FRY.lookupByAccessibilityLabel(@"Slider").touch([FRYTouch touchStarting:0.000
                                                                           points:40
    ...
    FRY.lookup([NSPredicate predicateWithFormat:@"fry_accessibilityLabel = 'Slider=0' || fry_accessibilityLabel = 'Slider=5'"]).count(1);
    ...
    FRY.lookup([NSPredicate predicateWithFormat:@"fry_accessibilityLabel = 'Slider=100' || fry_accessibilityLabel = 'Slider=95'"]).count(1);
    ...
    FRY.lookupByAccessibilityLabel(@"Slider=50").count(1);
}

- (void)testStepper
{
    for ( NSUInteger i = 0; i < 5; i++) {
        FRY.lookupByAccessibilityLabel(@"Increment").tap();
    }
    FRY.lookupByAccessibilityLabel(@"Slider=75").count(1);

    for ( NSUInteger i = 0; i < 5; i++) {
        FRY.lookupByAccessibilityLabel(@"Decrement").tap();
    }
    FRY.lookupByAccessibilityLabel(@"Slider=50").count(1);
}
...
{
    FRY.lookupByAccessibilityLabel(@"Switch").tap();
    FRY.lookupByAccessibilityLabel(@"In progress").count(1);

    FRY.lookupByAccessibilityLabel(@"Switch").tap();
    FRY.lookupByAccessibilityLabel(@"In progress").count(0);
